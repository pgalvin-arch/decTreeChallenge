...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{⚠️ The Problem Revealed}, colframe=quarto-callout-warning-color-frame, arc=.35mm, coltitle=black, breakable, colback=white, toptitle=1mm, toprule=.15mm, left=2mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, leftrule=.75mm]
